    ...
    run: async function (client, message, args) {
        ...
        if (serverQueue) {
            ...
            let thing = new MessageEmbed()
                .setAuthor("Song has been added to queue", "https://c.tenor.com/HJvqN2i4Zs4AAAAj/milk-and-mocha-cute.gif")
        ...
        const play = async (song) => {
            ...
            let thing = new MessageEmbed()
                .setAuthor("Started Playing Music!", "https://c.tenor.com/HJvqN2i4Zs4AAAAj/milk-and-mocha-cute.gif")
                .setThumbnail(song.img)
                .setColor("BLUE")
                .addField("Name", song.title, true)
                .addField("Duration", song.duration, true)
